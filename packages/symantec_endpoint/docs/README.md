...
| symantec.file.hash.crc32 | CRC32 Hash of file | keyword |
| symantec.firewall.acct_stat | Accounting state (RADIUS) | keyword |
| symantec.firewall.acktime | Alarm Acknowledge Time | keyword |
| symantec.firewall.act | Action | keyword |
| symantec.firewall.action | Status of the session | keyword |
| symantec.firewall.activity | HA activity message | keyword |
| symantec.firewall.addr | IP Address | ip |
| symantec.firewall.addr_type | Address Type | keyword |
| symantec.firewall.addrgrp | Address Group | keyword |
| symantec.firewall.adgroup | AD Group Name | keyword |
| symantec.firewall.admin | Admin User | keyword |
| symantec.firewall.age | Time in seconds - time passed since last seen | integer |
| symantec.firewall.agent | User agent - eg. agent="Mozilla/5.0" | keyword |
| symantec.firewall.alarmid | Alarm ID | integer |
| symantec.firewall.alert | Alert | keyword |
| symantec.firewall.analyticscksum | The checksum of the file submitted for analytics | keyword |
| symantec.firewall.analyticssubmit | The flag for analytics submission | keyword |
| symantec.firewall.ap | Access Point | keyword |
| symantec.firewall.app-type | Address Type | keyword |
| symantec.firewall.appact | The security action from app control | keyword |
| symantec.firewall.appid | Application ID | integer |
| symantec.firewall.applist | Application Control profile | keyword |
| symantec.firewall.apprisk | Application Risk Level | keyword |
| symantec.firewall.apscan | The name of the AP, which scanned and detected the rogue AP | keyword |
| symantec.firewall.apsn | Access Point | keyword |
| symantec.firewall.apstatus | Access Point status | keyword |
| symantec.firewall.aptype | Access Point type | keyword |
| symantec.firewall.assigned | Assigned IP Address | ip |
| symantec.firewall.assignip | Assigned IP Address | ip |
| symantec.firewall.attachment | The flag for email attachement | keyword |
| symantec.firewall.attack | Attack Name | keyword |
| symantec.firewall.attackcontext | The trigger patterns and the packetdata with base64 encoding | keyword |
| symantec.firewall.attackcontextid | Attack context id / total | keyword |
| symantec.firewall.attackid | Attack ID | integer |
| symantec.firewall.auditid | Audit ID | long |
| symantec.firewall.auditscore | The Audit Score | keyword |
| symantec.firewall.audittime | The time of the audit | long |
| symantec.firewall.authgrp | Authorization Group | keyword |
| symantec.firewall.authid | Authentication ID | keyword |
| symantec.firewall.authproto | The protocol that initiated the authentication | keyword |
| symantec.firewall.authserver | Authentication server | keyword |
| symantec.firewall.bandwidth | Bandwidth | keyword |
| symantec.firewall.banned_rule | NAC quarantine Banned Rule Name | keyword |
| symantec.firewall.banned_src | NAC quarantine Banned Source IP | keyword |
| symantec.firewall.banword | Banned word | keyword |
| symantec.firewall.botnetdomain | Botnet Domain Name | keyword |
| symantec.firewall.botnetip | Botnet IP Address | ip |
| symantec.firewall.bssid | Service Set ID | keyword |
| symantec.firewall.call_id | Caller ID | keyword |
| symantec.firewall.carrier_ep | The FortiOS Carrier end-point identification | keyword |
| symantec.firewall.cat | DNS category ID | integer |
| symantec.firewall.category | Authentication category | keyword |
| symantec.firewall.cc | CC Email Address | keyword |
| symantec.firewall.cdrcontent | Cdrcontent | keyword |
| symantec.firewall.centralnatid | Central NAT ID | integer |
| symantec.firewall.cert | Certificate | keyword |
| symantec.firewall.cert-type | Certificate type | keyword |
| symantec.firewall.certhash | Certificate hash | keyword |
| symantec.firewall.cfgattr | Configuration attribute | keyword |
| symantec.firewall.cfgobj | Configuration object | keyword |
| symantec.firewall.cfgpath | Configuration path | keyword |
| symantec.firewall.cfgtid | Configuration transaction ID | keyword |
| symantec.firewall.cfgtxpower | Configuration TX power | integer |
| symantec.firewall.channel | Wireless Channel | integer |
| symantec.firewall.channeltype | SSH channel type | keyword |
| symantec.firewall.chassisid | Chassis ID | integer |
| symantec.firewall.checksum | The checksum of the scanned file | keyword |
| symantec.firewall.chgheaders | HTTP Headers | keyword |
| symantec.firewall.cldobjid | Connector object ID | keyword |
| symantec.firewall.client_addr | Wifi client address | keyword |
| symantec.firewall.cloudaction | Cloud Action | keyword |
| symantec.firewall.clouduser | Cloud User | keyword |
| symantec.firewall.column | VOIP Column | integer |
| symantec.firewall.command | CLI Command | keyword |
| symantec.firewall.community | SNMP Community | keyword |
| symantec.firewall.configcountry | Configuration country | keyword |
| symantec.firewall.connection_type | FortiClient Connection Type | keyword |
| symantec.firewall.conserve | Flag for conserve mode | keyword |
| symantec.firewall.constraint | WAF http protocol restrictions | keyword |
| symantec.firewall.contentdisarmed | Email scanned content | keyword |
| symantec.firewall.contenttype | Content Type from HTTP header | keyword |
| symantec.firewall.cookies | VPN Cookie | keyword |
| symantec.firewall.count | Counts of action type | integer |
| symantec.firewall.countapp | Number of App Ctrl logs associated with the session | integer |
| symantec.firewall.countav | Number of AV logs associated with the session | integer |
| symantec.firewall.countcifs | Number of CIFS logs associated with the session | integer |
| symantec.firewall.countdlp | Number of DLP logs associated with the session | integer |
| symantec.firewall.countdns | Number of DNS logs associated with the session | integer |
| symantec.firewall.countemail | Number of email logs associated with the session | integer |
| symantec.firewall.countff | Number of ff logs associated with the session | integer |
| symantec.firewall.countips | Number of IPS logs associated with the session | integer |
| symantec.firewall.countssh | Number of SSH logs associated with the session | integer |
| symantec.firewall.countssl | Number of SSL logs associated with the session | integer |
| symantec.firewall.countwaf | Number of WAF logs associated with the session | integer |
| symantec.firewall.countweb | Number of Web filter logs associated with the session | integer |
| symantec.firewall.cpu | CPU Usage | integer |
| symantec.firewall.craction | Client Reputation Action | integer |
| symantec.firewall.criticalcount | Number of critical ratings | integer |
| symantec.firewall.crl | Client Reputation Level | keyword |
| symantec.firewall.crlevel | Client Reputation Level | keyword |
| symantec.firewall.crscore | Some description | integer |
| symantec.firewall.cveid | CVE ID | keyword |
| symantec.firewall.daemon | Daemon name | keyword |
| symantec.firewall.datarange | Data range for reports | keyword |
| symantec.firewall.date | Date | keyword |
| symantec.firewall.ddnsserver | DDNS server | ip |
| symantec.firewall.desc | Description | keyword |
| symantec.firewall.detectionmethod | Detection method | keyword |
| symantec.firewall.devcategory | Device category | keyword |
| symantec.firewall.devintfname | HA device Interface Name | keyword |
| symantec.firewall.devtype | Device type | keyword |
| symantec.firewall.dhcp_msg | DHCP Message | keyword |
| symantec.firewall.dintf | Destination interface | keyword |
| symantec.firewall.disk | Assosciated disk | keyword |
| symantec.firewall.disklograte | Disk logging rate | long |
| symantec.firewall.dlpextra | DLP extra information | keyword |
| symantec.firewall.docsource | DLP fingerprint document source | keyword |
| symantec.firewall.domainctrlauthstate | CIFS domain auth state | integer |
| symantec.firewall.domainctrlauthtype | CIFS domain auth type | integer |
| symantec.firewall.domainctrldomain | CIFS domain auth domain | keyword |
| symantec.firewall.domainctrlip | CIFS Domain IP | ip |
| symantec.firewall.domainctrlname | CIFS Domain name | keyword |
| symantec.firewall.domainctrlprotocoltype | CIFS Domain connection protocol | integer |
| symantec.firewall.domainctrlusername | CIFS Domain username | keyword |
| symantec.firewall.domainfilteridx | Domain filter ID | integer |
| symantec.firewall.domainfilterlist | Domain filter name | keyword |
| symantec.firewall.ds | Direction with distribution system | keyword |
| symantec.firewall.dst_int | Destination interface | keyword |
| symantec.firewall.dstcountry | Destination country | keyword |
| symantec.firewall.dstdevcategory | Destination device category | keyword |
| symantec.firewall.dstdevtype | Destination device type | keyword |
| symantec.firewall.dstfamily | Destination OS family | keyword |
| symantec.firewall.dsthwvendor | Destination HW vendor | keyword |
| symantec.firewall.dsthwversion | Destination HW version | keyword |
| symantec.firewall.dstinetsvc | Destination interface service | keyword |
| symantec.firewall.dstintfrole | Destination interface role | keyword |
| symantec.firewall.dstosname | Destination OS name | keyword |
| symantec.firewall.dstosversion | Destination OS version | keyword |
| symantec.firewall.dstserver | Destination server | integer |
| symantec.firewall.dstssid | Destination SSID | keyword |
| symantec.firewall.dstswversion | Destination software version | keyword |
| symantec.firewall.dstunauthusersource | Destination unauthenticated source | keyword |
| symantec.firewall.dstuuid | UUID of the Destination IP address | keyword |
| symantec.firewall.duid | DHCP UID | keyword |
| symantec.firewall.eapolcnt | EAPOL packet count | integer |
| symantec.firewall.eapoltype | EAPOL packet type | keyword |
| symantec.firewall.encrypt | Whether the packet is encrypted or not | integer |
| symantec.firewall.encryption | Encryption method | keyword |
| symantec.firewall.epoch | Epoch used for locating file | integer |
| symantec.firewall.espauth | ESP Authentication | keyword |
| symantec.firewall.esptransform | ESP Transform | keyword |
| symantec.firewall.exch | Mail Exchanges from DNS response answer section | keyword |
| symantec.firewall.exchange | Mail Exchanges from DNS response answer section | keyword |
| symantec.firewall.expectedsignature | Expected SSL signature | keyword |
| symantec.firewall.expiry | FortiGuard override expiry timestamp | keyword |
| symantec.firewall.fams_pause | Symantec Analysis and Management Service Pause | integer |
| symantec.firewall.fazlograte | FortiAnalyzer Logging Rate | long |
| symantec.firewall.fctemssn | FortiClient Endpoint SSN | keyword |
| symantec.firewall.fctuid | FortiClient UID | keyword |
| symantec.firewall.field | NTP status field | keyword |
| symantec.firewall.filefilter | The filter used to identify the affected file | keyword |
| symantec.firewall.filehashsrc | Filehash source | keyword |
| symantec.firewall.filtercat | DLP filter category | keyword |
| symantec.firewall.filteridx | DLP filter ID | integer |
| symantec.firewall.filtername | DLP rule name | keyword |
| symantec.firewall.filtertype | DLP filter type | keyword |
| symantec.firewall.fortiguardresp | Antispam ESP value | keyword |
| symantec.firewall.forwardedfor | Email address forwarded | keyword |
| symantec.firewall.fqdn | FQDN | keyword |
| symantec.firewall.frametype | Wireless frametype | keyword |
| symantec.firewall.freediskstorage | Free disk integer | integer |
| symantec.firewall.from | From email address | keyword |
| symantec.firewall.from_vcluster | Source virtual cluster number | integer |
| symantec.firewall.fsaverdict | FSA verdict | keyword |
| symantec.firewall.fwserver_name | Web proxy server name | keyword |
| symantec.firewall.gateway | Gateway ip address for PPPoE status report | ip |
| symantec.firewall.green | Memory status | keyword |
| symantec.firewall.groupid | User Group ID | integer |
| symantec.firewall.ha-prio | HA Priority | integer |
| symantec.firewall.ha_group | HA Group | keyword |
| symantec.firewall.ha_role | HA Role | keyword |
| symantec.firewall.handshake | SSL Handshake | keyword |
| symantec.firewall.hash | Hash value of downloaded file | keyword |
| symantec.firewall.hbdn_reason | Heartbeat down reason | keyword |
| symantec.firewall.highcount | Highcount fabric summary | integer |
| symantec.firewall.host | Hostname | keyword |
| symantec.firewall.iaid | DHCPv6 id | keyword |
| symantec.firewall.icmpcode | Destination Port of the ICMP message | keyword |
| symantec.firewall.icmpid | Source port of the ICMP message | keyword |
| symantec.firewall.icmptype | The type of ICMP message | keyword |
| symantec.firewall.identifier | Network traffic identifier | integer |
| symantec.firewall.in_spi | IPSEC inbound SPI | keyword |
| symantec.firewall.incidentserialno | Incident serial number | integer |
| symantec.firewall.infected | Infected MMS | integer |
| symantec.firewall.infectedfilelevel | DLP infected file level | integer |
| symantec.firewall.informationsource | Information source | keyword |
| symantec.firewall.init | IPSEC init stage | keyword |
| symantec.firewall.initiator | Original login user name for Fortiguard override | keyword |
| symantec.firewall.interface | Related interface | keyword |
| symantec.firewall.intf | Related interface | keyword |
| symantec.firewall.invalidmac | The MAC address with invalid OUI | keyword |
| symantec.firewall.ip | Related IP | ip |
| symantec.firewall.iptype | Related IP type | keyword |
| symantec.firewall.keyword | Keyword used for search | keyword |
| symantec.firewall.kind | VOIP kind | keyword |
| symantec.firewall.lanin | LAN incoming traffic in bytes | long |
| symantec.firewall.lanout | LAN outbound traffic in bytes | long |
| symantec.firewall.lease | DHCP lease | integer |
| symantec.firewall.license_limit | Maximum Number of FortiClients for the License | keyword |
| symantec.firewall.limit | Virtual Domain Resource Limit | integer |
| symantec.firewall.line | VOIP line | keyword |
| symantec.firewall.live | Time in seconds | integer |
| symantec.firewall.local | Local IP for a PPPD Connection | ip |
| symantec.firewall.log | Log message | keyword |
| symantec.firewall.login | SSH login | keyword |
| symantec.firewall.lowcount | Fabric lowcount | integer |
| symantec.firewall.mac | DHCP mac address | keyword |
| symantec.firewall.malform_data | VOIP malformed data | integer |
| symantec.firewall.malform_desc | VOIP malformed data description | keyword |
| symantec.firewall.manuf | Manufacturer name | keyword |
| symantec.firewall.masterdstmac | Master mac address for a host with multiple network interfaces | keyword |
| symantec.firewall.mastersrcmac | The master MAC address for a host that has multiple network interfaces | keyword |
| symantec.firewall.mediumcount | Fabric medium count | integer |
| symantec.firewall.mem | Memory usage system statistics | integer |
| symantec.firewall.meshmode | Wireless mesh mode | keyword |
| symantec.firewall.message_type | VOIP message type | keyword |
| symantec.firewall.method | HTTP method | keyword |
| symantec.firewall.mgmtcnt | The number of unauthorized client flooding managemet frames | integer |
| symantec.firewall.mode | IPSEC mode | keyword |
| symantec.firewall.module | PCI-DSS module | keyword |
| symantec.firewall.monitor-name | Health Monitor Name | keyword |
| symantec.firewall.monitor-type | Health Monitor Type | keyword |
| symantec.firewall.mpsk | Wireless MPSK | keyword |
| symantec.firewall.msgproto | Message Protocol Number | keyword |
| symantec.firewall.mtu | Max Transmission Unit Value | integer |
| symantec.firewall.name | Name | keyword |
| symantec.firewall.nat | NAT IP Address | keyword |
| symantec.firewall.netid | Connector NetID | keyword |
| symantec.firewall.new_status | New status on user change | keyword |
| symantec.firewall.new_value | New Virtual Domain Name | keyword |
| symantec.firewall.newchannel | New Channel Number | integer |
| symantec.firewall.newchassisid | New Chassis ID | integer |
| symantec.firewall.newslot | New Slot Number | integer |
| symantec.firewall.nextstat | Time interval in seconds for the next statistics. | integer |
| symantec.firewall.nf_type | Notification Type | keyword |
| symantec.firewall.noise | Wifi Noise | integer |
| symantec.firewall.old_status | Original Status | keyword |
| symantec.firewall.old_value | Original Virtual Domain name | keyword |
| symantec.firewall.oldchannel | Original channel | integer |
| symantec.firewall.oldchassisid | Original Chassis Number | integer |
| symantec.firewall.oldslot | Original Slot Number | integer |
| symantec.firewall.oldsn | Old Serial number | keyword |
| symantec.firewall.oldwprof | Old Web Filter Profile | keyword |
| symantec.firewall.onwire | A flag to indicate if the AP is onwire or not | keyword |
| symantec.firewall.opercountry | Operating Country | keyword |
| symantec.firewall.opertxpower | Operating TX power | integer |
| symantec.firewall.osname | Operating System name | keyword |
| symantec.firewall.osversion | Operating System version | keyword |
| symantec.firewall.out_spi | Out SPI | keyword |
| symantec.firewall.outintf | Out interface | keyword |
| symantec.firewall.passedcount | Fabric passed count | integer |
| symantec.firewall.passwd | Changed user password information | keyword |
| symantec.firewall.path | Path of looped configuration for security fabric | keyword |
| symantec.firewall.peer | WAN optimization peer | keyword |
| symantec.firewall.peer_notif | VPN peer notification | keyword |
| symantec.firewall.phase2_name | VPN phase2 name | keyword |
| symantec.firewall.phone | VOIP Phone | keyword |
| symantec.firewall.pid | Process ID | integer |
| symantec.firewall.policytype | Policy Type | keyword |
| symantec.firewall.poolname | IP Pool name | keyword |
| symantec.firewall.port | Log upload error port | integer |
| symantec.firewall.portbegin | IP Pool port number to begin | integer |
| symantec.firewall.portend | IP Pool port number to end | integer |
| symantec.firewall.probeproto | Link Monitor Probe Protocol | keyword |
| symantec.firewall.process | URL Filter process | keyword |
| symantec.firewall.processtime | Process time for reports | integer |
| symantec.firewall.profile | Profile Name | keyword |
| symantec.firewall.profile_vd | Virtual Domain Name | keyword |
| symantec.firewall.profilegroup | Profile Group Name | keyword |
| symantec.firewall.profiletype | Profile Type | keyword |
| symantec.firewall.qtypeval | DNS question type value | integer |
| symantec.firewall.quarskip | Quarantine skip explanation | keyword |
| symantec.firewall.quotaexceeded | If quota has been exceeded | keyword |
| symantec.firewall.quotamax | Maximum quota allowed - in seconds if time-based - in bytes if traffic-based | long |
| symantec.firewall.quotatype | Quota type | keyword |
| symantec.firewall.quotaused | Quota used - in seconds if time-based - in bytes if trafficbased) | long |
| symantec.firewall.radioband | Radio band | keyword |
| symantec.firewall.radioid | Radio ID | integer |
| symantec.firewall.radioidclosest | Radio ID on the AP closest the rogue AP | integer |
| symantec.firewall.radioiddetected | Radio ID on the AP which detected the rogue AP | integer |
| symantec.firewall.rate | Wireless rogue rate value | keyword |
| symantec.firewall.rawdata | Raw data value | keyword |
| symantec.firewall.rawdataid | Raw data ID | keyword |
| symantec.firewall.rcvddelta | Received bytes delta | keyword |
| symantec.firewall.reason | Alert reason | keyword |
| symantec.firewall.received | Server key exchange received | integer |
| symantec.firewall.receivedsignature | Server key exchange received signature | keyword |
| symantec.firewall.red | Memory information in red | keyword |
| symantec.firewall.referralurl | Web filter referralurl | keyword |
| symantec.firewall.remote | Remote PPP IP address | ip |
| symantec.firewall.remotewtptime | Remote Wifi Radius authentication time | keyword |
| symantec.firewall.reporttype | Report type | keyword |
| symantec.firewall.reqtype | Request type | keyword |
| symantec.firewall.request_name | VOIP request name | keyword |
| symantec.firewall.result | VPN phase result | keyword |
| symantec.firewall.role | VPN Phase 2 role | keyword |
| symantec.firewall.rssi | Received signal strength indicator | integer |
| symantec.firewall.rsso_key | RADIUS SSO attribute value | keyword |
| symantec.firewall.ruledata | Rule data | keyword |
| symantec.firewall.ruletype | Rule type | keyword |
| symantec.firewall.scanned | Number of Scanned MMSs | integer |
| symantec.firewall.scantime | Scanned time | long |
| symantec.firewall.scope | FortiGuard Override Scope | keyword |
| symantec.firewall.security | Wireless rogue security | keyword |
| symantec.firewall.sensitivity | Sensitivity for document fingerprint | keyword |
| symantec.firewall.sensor | NAC Sensor Name | keyword |
| symantec.firewall.sentdelta | Sent bytes delta | keyword |
| symantec.firewall.seq | Sequence number | keyword |
| symantec.firewall.serial | WAN optimisation serial | keyword |
| symantec.firewall.serialno | Serial number | keyword |
| symantec.firewall.server | AD server FQDN or IP | keyword |
| symantec.firewall.session_id | Session ID | keyword |
| symantec.firewall.sessionid | WAD Session ID | integer |
| symantec.firewall.setuprate | Session Setup Rate | long |
| symantec.firewall.severity | Severity | keyword |
| symantec.firewall.shaperdroprcvdbyte | Received bytes dropped by shaper | integer |
| symantec.firewall.shaperdropsentbyte | Sent bytes dropped by shaper | integer |
| symantec.firewall.shaperperipdropbyte | Dropped bytes per IP by shaper | integer |
| symantec.firewall.shaperperipname | Traffic shaper name (per IP) | keyword |
| symantec.firewall.shaperrcvdname | Traffic shaper name for received traffic | keyword |
| symantec.firewall.shapersentname | Traffic shaper name for sent traffic | keyword |
| symantec.firewall.shapingpolicyid | Traffic shaper policy ID | integer |
| symantec.firewall.signal | Wireless rogue API signal | integer |
| symantec.firewall.size | Email size in bytes | long |
| symantec.firewall.slot | Slot number | integer |
| symantec.firewall.sn | Security fabric serial number | keyword |
| symantec.firewall.snclosest | SN of the AP closest to the rogue AP | keyword |
| symantec.firewall.sndetected | SN of the AP which detected the rogue AP | keyword |
| symantec.firewall.snmeshparent | SN of the mesh parent | keyword |
| symantec.firewall.spi | IPSEC SPI | keyword |
| symantec.firewall.src_int | Source interface | keyword |
| symantec.firewall.srccountry | Source country | keyword |
| symantec.firewall.srcfamily | Source family | keyword |
| symantec.firewall.srchwvendor | Source hardware vendor | keyword |
| symantec.firewall.srchwversion | Source hardware version | keyword |
| symantec.firewall.srcinetsvc | Source interface service | keyword |
| symantec.firewall.srcintfrole | Source interface role | keyword |
| symantec.firewall.srcname | Source name | keyword |
| symantec.firewall.srcserver | Source server | integer |
| symantec.firewall.srcssid | Source SSID | keyword |
| symantec.firewall.srcswversion | Source software version | keyword |
| symantec.firewall.srcuuid | Source UUID | keyword |
| symantec.firewall.sscname | SSC name | keyword |
| symantec.firewall.ssid | Base Service Set ID | keyword |
| symantec.firewall.sslaction | SSL Action | keyword |
| symantec.firewall.ssllocal | WAD SSL local | keyword |
| symantec.firewall.sslremote | WAD SSL remote | keyword |
| symantec.firewall.stacount | Number of stations/clients | integer |
| symantec.firewall.stage | IPSEC stage | keyword |
| symantec.firewall.stamac | 802.1x station mac | keyword |
| symantec.firewall.state | Admin login state | keyword |
| symantec.firewall.status | Status | keyword |
| symantec.firewall.stitch | Automation stitch triggered | keyword |
| symantec.firewall.subject | Email subject | keyword |
| symantec.firewall.submodule | Configuration Sub-Module Name | keyword |
| symantec.firewall.subservice | AV subservice | keyword |
| symantec.firewall.subtype | Log subtype | keyword |
| symantec.firewall.suspicious | Number of Suspicious MMSs | integer |
| symantec.firewall.switchproto | Protocol change information | keyword |
| symantec.firewall.sync_status | The sync status with the master | keyword |
| symantec.firewall.sync_type | The sync type with the master | keyword |
| symantec.firewall.sysuptime | System uptime | keyword |
| symantec.firewall.tamac | the MAC address of Transmitter, if none, then Receiver | keyword |
| symantec.firewall.threattype | WIDS threat type | keyword |
| symantec.firewall.time | Time of the event | keyword |
| symantec.firewall.to | Email to field | keyword |
| symantec.firewall.to_vcluster | destination virtual cluster number | integer |
| symantec.firewall.total | Total memory | integer |
| symantec.firewall.totalsession | Total Number of Sessions | integer |
| symantec.firewall.trace_id | Session clash trace ID | keyword |
| symantec.firewall.trandisp | NAT translation type | keyword |
| symantec.firewall.transid | HTTP transaction ID | integer |
| symantec.firewall.translationid | DNS filter transaltion ID | keyword |
| symantec.firewall.trigger | Automation stitch trigger | keyword |
| symantec.firewall.trueclntip | File filter true client IP | ip |
| symantec.firewall.tunnelid | IPSEC tunnel ID | integer |
| symantec.firewall.tunnelip | IPSEC tunnel IP | ip |
| symantec.firewall.tunneltype | IPSEC tunnel type | keyword |
| symantec.firewall.type | Module type | keyword |
| symantec.firewall.ui | Admin authentication UI type | keyword |
| symantec.firewall.unauthusersource | Unauthenticated user source | keyword |
| symantec.firewall.unit | Power supply unit | integer |
| symantec.firewall.urlfilteridx | URL filter ID | integer |
| symantec.firewall.urlfilterlist | URL filter list | keyword |
| symantec.firewall.urlsource | URL filter source | keyword |
| symantec.firewall.urltype | URL filter type | keyword |
| symantec.firewall.used | Number of Used IPs | integer |
| symantec.firewall.used_for_type | Connection for the type | integer |
| symantec.firewall.utmaction | Security action performed by UTM | keyword |
| symantec.firewall.vap | Virtual AP | keyword |
| symantec.firewall.vapmode | Virtual AP mode | keyword |
| symantec.firewall.vcluster | virtual cluster id | integer |
| symantec.firewall.vcluster_member | Virtual cluster member | integer |
| symantec.firewall.vcluster_state | Virtual cluster state | keyword |
| symantec.firewall.vd | Virtual Domain Name | keyword |
| symantec.firewall.vdname | Virtual Domain Name | keyword |
| symantec.firewall.vendorurl | Vulnerability scan vendor name | keyword |
| symantec.firewall.version | Version | keyword |
| symantec.firewall.vip | Virtual IP | keyword |
| symantec.firewall.virus | Virus name | keyword |
| symantec.firewall.virusid | Virus ID (unique virus identifier) | integer |
| symantec.firewall.voip_proto | VOIP protocol | keyword |
| symantec.firewall.vpn | VPN description | keyword |
| symantec.firewall.vpntunnel | IPsec Vpn Tunnel Name | keyword |
| symantec.firewall.vpntype | The type of the VPN tunnel | keyword |
| symantec.firewall.vrf | VRF number | integer |
| symantec.firewall.vulncat | Vulnerability Category | keyword |
| symantec.firewall.vulnid | Vulnerability ID | integer |
| symantec.firewall.vulnname | Vulnerability name | keyword |
| symantec.firewall.vwlid | VWL ID | integer |
| symantec.firewall.vwlquality | VWL quality | keyword |
| symantec.firewall.vwlservice | VWL service | keyword |
| symantec.firewall.vwpvlanid | VWP VLAN ID | integer |
| symantec.firewall.wanin | WAN incoming traffic in bytes | long |
| symantec.firewall.wanoptapptype | WAN Optimization Application type | keyword |
| symantec.firewall.wanout | WAN outgoing traffic in bytes | long |
| symantec.firewall.weakwepiv | Weak Wep Initiation Vector | keyword |
| symantec.firewall.xauthgroup | XAuth Group Name | keyword |
| symantec.firewall.xauthuser | XAuth User Name | keyword |
| symantec.firewall.xid | Wireless X ID | integer |
